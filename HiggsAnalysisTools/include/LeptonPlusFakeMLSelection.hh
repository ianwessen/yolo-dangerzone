...
#ifndef LeptonPlusFakeMLSelection_h
#define LeptonPlusFakeMLSelection_h
...
class LeptonPlusFakeMLSelection : public Higgs{
public:
  
  //! constructor
  LeptonPlusFakeMLSelection(TTree *tree=0);
  //! destructor
  virtual ~LeptonPlusFakeMLSelection();
  //! loop over events
  void Loop();
